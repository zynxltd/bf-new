        ...
        <div class="admin-actions">
            ...
            <form action="{{ route('admin.blogs.store') }}" method="POST">
                ...
                <div class="form-group-admin">
                    ...
                    <textarea class="form-control-admin @error('content') is-invalid @enderror" id="content" name="content" rows="20" required placeholder="Write your blog post content here... HTML is allowed.">{{ old('content') }}</textarea>
                    @error('content')
                        <div style="color: #dc3545; font-size: 13px; margin-top: 6px;">{{ $message }}</div>
                    @enderror
